...
const LabsPage = () => {
  ...
  return h('div', { className: 'min-h-screen bg-[#050505] text-[#f0f0f0] overflow-hidden selection:bg-[#00ff66] selection:text-black font-sans' },
    ...
    h('div', { className: 'fixed inset-0 z-0 bg-cover bg-center grayscale contrast-[1.3] brightness-[0.42] pointer-events-none', style: { backgroundImage: 'url("../HomePageAssets/projects-bg-2.webp")' } }),
